...
public class HibernateDAOFactory implements DAOFactory, TaxonomicDAO, PersonDAO, RecordDAO, SampleDAO, FolderDAO, FolderTypeDAO, FeatureDAO, AuditDAO, BacklogStatusDAO, StratLexDAO, UserDAO, StageDAO, SiteDAO {
	...
	public Audit getAudit(int auditId) throws StorageAccessException {
		return HibernateUtils.getFirst(provider, "FROM Audit AS a WHERE a.auditId = ?", auditId, Audit.class);
	}
	...
	public ConfidentialGroup getConfidentialGroup(Integer id) throws StorageAccessException {
		return HibernateUtils.get(provider, nz.cri.gns.fred.hibernate.ConfidentialGroup.class, id);
	}
