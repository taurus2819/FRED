...
public class FullSampPropRecord {
	...
	protected int id;
	private Object[] values = new Object[77];
	...
	protected FullSampPropRecord(int id, PageState state)
		...
		try {
			...
			values[18] = ((rs.getString(17) != null) ? new Integer(rs.getInt(17)) : null);
			values[19] = rs.getString(18);
			values[20] = rs.getString(19);
			values[21] = ((rs.getString(20) != null) ? new Integer(rs.getInt(20)) : null);
			values[22] = rs.getString(21);
			values[23] = rs.getString(22);
			values[24] = ((rs.getString(23) != null) ? new Integer(rs.getInt(23)) : null);
			values[25] = rs.getString(24);
			values[26] = rs.getString(25);
			values[27] = ((rs.getString(26) != null) ? new Double(rs.getDouble(26)) : null);
			values[28] = ((rs.getString(27) != null) ? new Double(rs.getDouble(27)) : null);
			values[29] = ((rs.getString(28) != null) ? new Integer(rs.getInt(28)) : null);
			values[30] = rs.getString(29);
			values[31] = rs.getString(30);
			values[32] = ((rs.getString(31) != null) ? new Integer(rs.getInt(31)) : null);
			values[33] = rs.getString(32);
			values[34] = rs.getString(33);
			values[35] = ((rs.getString(34) != null) ? new Integer(rs.getInt(34)) : null);
			values[36] = rs.getString(35);
			values[37] = rs.getString(36);
			values[38] = ((rs.getString(37) != null) ? new Double(rs.getDouble(37)) : null);
			values[39] = ((rs.getString(38) != null) ? new Double(rs.getDouble(38)) : null);
			values[41] = rs.getString(39);
			values[42] = ((rs.getString(40) != null) ? new Integer(rs.getInt(40)) : null);
			values[43] = rs.getString(41);
			values[44] = ((rs.getString(42) != null) ? new Integer(rs.getInt(42)) : null);
			values[45] = rs.getString(43);
			values[46] = rs.getString(44);
			values[47] = ((rs.getString(45) != null) ? new Integer(rs.getInt(45)) : null);
			values[48] = rs.getString(46);
			values[49] = ((rs.getString(47) != null) ? new Integer(rs.getInt(47)) : null);
			values[50] = rs.getString(48);
			values[51] = rs.getString(49);
			values[52] = ((rs.getString(50) != null) ? new Integer(rs.getInt(50)) : null);
			values[53] = rs.getString(51);
			values[54] = rs.getString(52);
			values[55] = ((rs.getString(53) != null) ? new Integer(rs.getInt(53)) : null);
			values[56] = rs.getString(54);
			values[57] = ((rs.getString(55) != null) ? new Integer(rs.getInt(55)) : null);
			values[58] = rs.getString(56);
			values[59] = ((rs.getString(57) != null) ? new Integer(rs.getInt(57)) : null);
			values[60] = rs.getString(58);
			values[61] = ((rs.getString(59) != null) ? new Integer(rs.getInt(59)) : null);
			values[62] = rs.getString(60);
			values[63] = ((rs.getString(61) != null) ? new Integer(rs.getInt(61)) : null);
			values[64] = rs.getString(62);
			values[65] = rs.getString(63);
			values[66] = ((rs.getString(64) != null) ? new Integer(rs.getInt(64)) : null);
			values[67] = rs.getString(65);
			values[68] = ((rs.getString(66) != null) ? new Integer(rs.getInt(66)) : null);
			values[69] = rs.getString(67);
			values[70] = ((rs.getString(68) != null) ? new Integer(rs.getInt(68)) : null);
			...
			query =
				"SELECT Person_ID, Name FROM Person_View NATURAL JOIN Collector WHERE Record_ID = ? ORDER BY Name"
					+ this.id;
			rs = conn.executeQuery(query, types, data);
			Vector coll = new Vector();
			while (rs.next()) {
				coll.add(new KeyValueObject(rs.getString(1), rs.getString(2)));
			}
			rs.close();
			values[10] = coll;
			rs.close();
			
			query = "SELECT SENT_TO, FOSSIL_GROUP_ID, FOSSIL_GROUP, SENT_DATE, DATE_ROUNDING, PERSON_ID, PERSON_NAME, LAB_ID, LAB_NAME, COMMENTS "
			+ "FROM Sent_To_View WHERE Record_ID = ?";
			rs = conn.executeQuery(query, types, data);
			Vector sentToVec = new Vector();
			while (rs.next()) {
				SentTo sentTo = new SentTo(rs.getString(1));
				sentTo.setFossilGroupId(((rs.getString(2) != null) ? new Integer(rs.getInt(2)) : null));
				sentTo.setFossilGroup(rs.getString(3));
				sentTo.setDate(rs.getDate(4));
				sentTo.setDateRounding(rs.getString(5));
				sentTo.setPersonId(((rs.getString(6) != null) ? new Integer(rs.getInt(6)) : null));
				sentTo.setPerson(rs.getString(7));
				sentTo.setLabId(((rs.getString(8) != null) ? new Integer(rs.getInt(8)) : null));
