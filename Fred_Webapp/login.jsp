...
%>	
	...
	<tr align="left"><td class="heading">External Users&nbsp;&nbsp;</td><td>Please click <a href='http://data.gns.cri.nz/register/user_reg.jsp?DBase=FRED' target='register' class='boldlink'>here</a> to register for an account</td></tr>
	</table>
