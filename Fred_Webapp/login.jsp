...
%>	
	...
	<tr align="left"><td class="heading">External Users&nbsp;&nbsp;</td><td>Please click <a href='/register/index.jsp?Schema=FRED' target='register' class='boldlink'>here</a> to register for an account</td></tr>
	</table>
