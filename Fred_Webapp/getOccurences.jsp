...
%><?xml version="1.0" encoding="UTF-8"?><%
	...
	if (taxon != null && taxon.trim().length() == 0)
		taxon = null;	
	Integer maxAge = (request.getParameter("max_age") != null) ? new Integer(request.getParameter("max_age")) : null;
	Integer minAge = (request.getParameter("min_age") != null) ? new Integer(request.getParameter("min_age")) : null;
