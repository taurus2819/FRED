...
%><%
	...
	if (features != null && features.size() > 0) {
		...
		if (localityFlag) {
			...
			out.println("Stratigraphic Name\tInferred Stage Lower\tInferred Lower Modifier\tInferred Stage Upper\tInferred Upper Modifier\tKnown Stage Lower\tKnown Lower Modifier\tKnown Stage Upper\tKnown Upper Modifier\t");
		}
