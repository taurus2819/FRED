...
%><%
	...
	ResultSet rs = statement.executeQuery("SELECT COUNT(*) FROM Pal_List WHERE Taxa_ID IS NULL AND Taxonomic_Name IS NOT NULL");
	rs.next();
	...
	Object data2[];
	data2 = new Object[2];
	rs = statement.executeQuery("SELECT Taxonomic_Name, Group_ID, Pal_List_ID FROM Pal_List WHERE Taxa_ID IS NULL AND Taxonomic_Name IS NOT NULL");
	while (rs.next()) {
