...
%><%
	try {
		...
		<tr><td colspan="2" style="color: #ff0000;">January 2008: A bug has been discovered in the code for saving taxonomic lists in version 2.1 of the spreadsheet.  Please use version 2.1.1 which you can download below.</td></tr>
