...
<tr><td style="color: #FF0000" colspan="5">A new <i>Advanced Query Builder</i> is now available and can be used to generate more complex queries than this form.  Use the link above to access the new builder</td></tr>
<tr><td>&nbsp;</td></tr>
