...
%><%
	...
	if (request.getParameter("ID") != null) {
		...
		//List data
		PaleontologyRecord palRec = (PaleontologyRecord) PaleontologyRecord.getData(Integer.parseInt(recID), user, state);
		...
		if (palRec.get(PaleontologyRecord.SAMPLE_NAME) != null) {
			out.print(palRec.get(PaleontologyRecord.SAMPLE_NAME));
		} else {
			out.print("_______/f_____");
		}
		out.println("</td></tr>");
		out.print("<tr><td class='hugeheading'>FOSSIL RECORD FORM</td></tr>");		
