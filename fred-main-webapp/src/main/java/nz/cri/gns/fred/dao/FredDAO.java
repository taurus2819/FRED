...
public interface FredDAO {
	...
	//to be rationalised
    /**
     * Returns the masterfile folder of this record. Provided to bypass having
     * to instantiate Sample and Feature objects
     *
    ...
    /**
     * Locates, if one exists, a Stage entry in persistent storage that uses the
     * given stages (by id) and has uncertainty as specified.
     *
