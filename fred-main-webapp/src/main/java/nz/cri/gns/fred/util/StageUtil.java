...
public class StageUtil extends ModelUtil {
    ...
    private static String getStageDesc(Stage stage, int nameType) throws NamingException, SQLException {
        ...
        if (stage.getLowerAge() != null) {
            ...
            desc.append(" (").append(stage.getBaseAge()).append(" - ").append(stage.getTopAge()).append(" Ma)");
        }
    ...
    /**
     * Returns true if the given stage differs from that described by the
     * arguments
     */
    ...
    public List<Age> getMatchingAges(String str, int maxMatches) throws StorageAccessException {
        ...
        criteria.add(Expression.or(Expression.ilike("name", str, MatchMode.START), Expression.ilike("code", str, MatchMode.START)));
