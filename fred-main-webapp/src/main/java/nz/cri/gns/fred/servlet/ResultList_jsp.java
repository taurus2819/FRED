...
public class ResultList_jsp extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (whereSQL!= null 
                    && tableName != null 
                    && queryStringParam != null || page != null || type != null) {
    ...
    private List<Sample> getSpatiallyFilteredSamples(SampleUtil sampleUtil, String[] locIdList, String querySQL) throws Exception {
