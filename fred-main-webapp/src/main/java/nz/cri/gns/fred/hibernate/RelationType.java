...
public class RelationType implements Serializable, nz.cri.gns.fred.model.RelationType {
   ...
   /** persistent field */
    ...
    /** full constructor */
    public RelationType(String name, Set relationshipTypes, Set relationships) {
        this.name = name;
