...
public class FeatureTest1 implements Serializable, nz.cri.gns.fred.model.FeatureTest1 {
...
//	public int compareTo(nz.cri.gns.fred.model.FeatureTest1 arg0) {
...
//	}
    ...
    public boolean equals(Object o) {
    	if (!(o instanceof FeatureTest1))
    		return false;
    	if (featureId == null || ((FeatureTest1)o).getFeatureId() == null)
    		return false;
    	return featureId.equals(((FeatureTest1)o).getFeatureId());
    }
	...
	public int hashCode() {
         ...
         * @param id FeatureId
         */
        public FeatureTest1(Integer id) {
            this.featureId = id;
        }
         ...
         * @param id FeatureId
         */
        public FeatureTest1(Integer id, FrNumber frnumber) {
            this.featureId = id;
            this.frNumber = frnumber;
        }
