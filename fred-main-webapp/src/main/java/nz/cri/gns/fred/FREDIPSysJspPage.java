...
public abstract class FREDIPSysJspPage extends IPSysJspPage {
    ...
    public static NewExtranetTemplate getFREDTemplate() {
        ...
        et.setButtons(new Link[]{
                    new CustomHTMLLink(htmlLink), new IconnedLink("index.jsp", "images/home.gif", "FRED Home"), new IconnedLink("http://data.gns.cri.nz/npc/index.jsp", "images/home.gif", "NPC Database"), new IconnedLink("folder_list.jsp", "images/edit.gif", "Data Entry"), new IconnedLink("simple_query.jsp", "images/search.gif", "Simple Query"), new IconnedLink("buildframe.jsp", "images/search.gif", "Advanced Query"), new IconnedLink("javascript:var x=window.open('http://maps.gns.cri.nz/website/fred_nz/o_index.htm', 'fred', 'toolbar=no,menu=no,resizable=yes,address=no');x.focus();", "images/map.gif", "Interactive Map"), new IconnedLink("admin.jsp", "images/edit.gif", "FRED Admin")
                });
