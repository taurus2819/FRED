...
Calendar = function (firstDayOfWeek, dateStr, dateAsStr, onSelected, onClose) {
this.activeDiv = null;
...
cell.className = "time";
cell.colSpan = 2;
cell.innerHTML = Calendar._TT["ROUNDING"] || "&nbsp;";
...
(function(){
function makeRoundingPart(className, init) {
var part = Calendar.createElement("span", cell);
part.className = className;
part.innerHTML = init;
part.colspan=3;
part.calendar = cal;
part.ttip = Calendar._TT["ROUNDING_PART"];
part.navtype = 50;
part._range = [];
part._range[0] = Calendar._TT["ROUNDING_DAY"];
part._range[1] = Calendar._TT["ROUNDING_MONTH"];
part._range[2] = Calendar._TT["ROUNDING_YEAR"];
...
cal.onUpdateRounding = function() {
this.rounding = R.innerHTML;
...
this.onSetRounding = this.onUpdateRounding = function() {};
}
